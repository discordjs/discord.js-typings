...
//#region Classes
	...
	class ClientManager {
		...
		public connectToWebSocket(token: string, resolve: Function, reject: Function);
	...
	export class Guild {
		...
		public setChannelPosition(channel: string | GuildChannel, position: number, relative?: boolean);
